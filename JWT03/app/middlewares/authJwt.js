...
export const isModeratorOrAdmin = async (req, res, next) => {
  try {
    ...
    // Si el usuario no tiene el rol de 'admin' ni 'moderator', respondemos con un error 403
    res.status(403).json({ message: "¡Se requiere el rol de administrador o moderador!" });
